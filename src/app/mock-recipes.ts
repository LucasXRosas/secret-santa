...
export const MOCK_RECIPES: RecipeModel[] = [
  {
    ...
    imgUrl: 'https://images.unsplash.com/photo-1612874742237-6526221588e3?w=600&auto=format&fit=crop&q=60',
    isFavorite: true,
    difficulty: 'medio',
    ingredients: [
  ...
  },
  {
    ...
    imgUrl: 'https://images.unsplash.com/photo-1592417817098-8f3d6eb19675?w=600&auto=format&fit=crop&q=60',
    isFavorite: false,
    difficulty: 'facil',
    ingredients: [
