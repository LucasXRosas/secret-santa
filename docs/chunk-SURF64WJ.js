...
function DashboardComponent_Conditional_19_For_2_Conditional_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", event_r4.draw_date, " ");
  }
}
function DashboardComponent_Conditional_19_For_2_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const event_r4 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" R$ ", event_r4.budget, " ");
  }
}
function DashboardComponent_Conditional_19_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(4, DashboardComponent_Conditional_19_For_2_Conditional_4_Template, 4, 1, "span", 22);
    \u0275\u0275conditionalCreate(5, DashboardComponent_Conditional_19_For_2_Conditional_5_Template, 4, 1, "span", 22);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
//# sourceMappingURL=chunk-SURF64WJ.js.map
