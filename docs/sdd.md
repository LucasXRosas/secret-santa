...
* **Figma/Stitch MCP:** `[https://www.figma.com/design/XAi2US0lA1xmbCKOxtJYRX/Design-System?node-id=0-1&t=BsTjcBPSrPZHSn84-1]` (Ler design tokens, cores e hierarquia visual).
