...
* **Figma/Stitch MCP:** `https://www.figma.com/design/XAi2US0lA1xmbCKOxtJYRX/Design-System?node-id=0-1&p=f&t=M83dxnStoX3b88v3-0` (Ler design tokens, cores e hierarquia visual).
...
* **Estilização & UI:** Tailwind CSS 4.3.0, Spartan UI (HLM), Lucide Angular (Ícones).
...
| :--- | :--- | :--- 
| `/` | `src/app/features/home/home.page.ts` | Público |
| `/login` | `src/app/features/login/login.page.ts` | Público |
| `/dashboard` | `src/app/features/dashboard/dashboard.page.ts` | Público |
