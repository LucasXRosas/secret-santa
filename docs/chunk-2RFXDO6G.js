...
(() => {
  ...
  }], null, { isOpen: [{ type: Input, args: [{ isSignal: true, alias: "isOpen", required: false }] }], closeSidenav: [{ type: Output, args: ["closeSidenav"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidenavComponent, { className: "SidenavComponent", filePath: "src/app/components/sidenav/sidenav.component.ts", lineNumber: 11 });
})();
...
//# sourceMappingURL=chunk-2RFXDO6G.js.map
