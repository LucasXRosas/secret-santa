...
var DashboardComponent_Conditional_18_Defer_3_DepsFn = () => [import("./chunk-6DWFAD2T.js").then((m) => m.BrlCurrencyPipe), import("./chunk-X5X5TS5U.js").then((m) => m.RelativeDatePipe)];
var _c0 = () => [1, 2];
...
function DashboardComponent_Conditional_18_Defer_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DashboardComponent_Conditional_18_Defer_0_Conditional_5_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r2);
...
function DashboardComponent_Conditional_18_Defer_0_Conditional_6_For_2_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 30)(1, "span", 28);
...
function DashboardComponent_Conditional_18_Defer_0_Conditional_6_For_2_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 30)(1, "span", 28);
    \u0275\u0275text(2, "payments");
    \u0275\u0275elementEnd();
...
function DashboardComponent_Conditional_18_Defer_0_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275listener("click", function DashboardComponent_Conditional_18_Defer_0_Conditional_6_For_2_Template_div_click_0_listener() {
      const event_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r0.abrirEvento(event_r4));
    });
    \u0275\u0275elementStart(1, "div")(2, "h3", 25);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 26)(5, "p", 27)(6, "span", 28);
    \u0275\u0275text(7, "person");
    \u0275\u0275elementEnd();
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "p", 27)(10, "span", 28);
    \u0275\u0275text(11, "location_on");
    \u0275\u0275elementEnd();
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "div", 29);
    \u0275\u0275conditionalCreate(14, DashboardComponent_Conditional_18_Defer_0_Conditional_6_For_2_Conditional_14_Template, 5, 3, "span", 30);
    \u0275\u0275conditionalCreate(15, DashboardComponent_Conditional_18_Defer_0_Conditional_6_For_2_Conditional_15_Template, 5, 3, "span", 30);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DashboardComponent_Conditional_18_Defer_0_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275repeaterCreate(1, DashboardComponent_Conditional_18_Defer_0_Conditional_6_For_2_Template, 16, 5, "div", 23, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function DashboardComponent_Conditional_18_Defer_0_Conditional_7_For_7_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 30)(1, "span", 28);
    \u0275\u0275text(2, "calendar_today");
    \u0275\u0275elementEnd();
...
function DashboardComponent_Conditional_18_Defer_0_Conditional_7_For_7_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 30)(1, "span", 28);
    \u0275\u0275text(2, "payments");
    \u0275\u0275elementEnd();
...
function DashboardComponent_Conditional_18_Defer_0_Conditional_7_For_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 32);
    \u0275\u0275listener("click", function DashboardComponent_Conditional_18_Defer_0_Conditional_7_For_7_Template_div_click_0_listener() {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "div", 29);
    \u0275\u0275conditionalCreate(14, DashboardComponent_Conditional_18_Defer_0_Conditional_7_For_7_Conditional_14_Template, 5, 3, "span", 30);
    \u0275\u0275conditionalCreate(15, DashboardComponent_Conditional_18_Defer_0_Conditional_7_For_7_Conditional_15_Template, 5, 3, "span", 30);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DashboardComponent_Conditional_18_Defer_0_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section")(1, "h2", 15)(2, "span", 16);
    \u0275\u0275text(3, "group");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " Participo de ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 18);
    \u0275\u0275repeaterCreate(6, DashboardComponent_Conditional_18_Defer_0_Conditional_7_For_7_Template, 16, 5, "div", 31, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function DashboardComponent_Conditional_18_Defer_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 14)(1, "h2", 15)(2, "span", 16);
    \u0275\u0275text(3, "star");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " Meus Sorteios ");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, DashboardComponent_Conditional_18_Defer_0_Conditional_5_Template, 9, 0, "div", 17)(6, DashboardComponent_Conditional_18_Defer_0_Conditional_6_Template, 3, 0, "div", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, DashboardComponent_Conditional_18_Defer_0_Conditional_7_Template, 8, 0, "section");
  }
  if (rf & 2) {
...
function DashboardComponent_Conditional_18_DeferLoading_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 33);
    \u0275\u0275text(1, " Preparando seus eventos... ");
    \u0275\u0275elementEnd();
  }
}
function DashboardComponent_Conditional_18_DeferPlaceholder_2_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 37)(1, "div");
    \u0275\u0275element(2, "div", 38);
    \u0275\u0275elementStart(3, "div", 39);
    \u0275\u0275element(4, "div", 40)(5, "div", 41);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 42);
    \u0275\u0275element(7, "div", 43)(8, "div", 44);
    \u0275\u0275elementEnd()();
  }
}
function DashboardComponent_Conditional_18_DeferPlaceholder_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 14)(1, "div", 34);
    \u0275\u0275element(2, "div", 35)(3, "div", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 18);
    \u0275\u0275repeaterCreate(5, DashboardComponent_Conditional_18_DeferPlaceholder_2_For_6_Template, 9, 0, "div", 37, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(5);
...
function DashboardComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domTemplate(0, DashboardComponent_Conditional_18_Defer_0_Template, 8, 2)(1, DashboardComponent_Conditional_18_DeferLoading_1_Template, 2, 0)(2, DashboardComponent_Conditional_18_DeferPlaceholder_2_Template, 7, 1);
    \u0275\u0275defer(3, 0, DashboardComponent_Conditional_18_Defer_3_DepsFn, 1, 2, null, 0, 1, \u0275\u0275deferEnableTimerScheduling);
    \u0275\u0275deferOnIdle();
  }
}
...
var DashboardComponent = class _DashboardComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], decls: 23, vars: 2, consts: [[300, null], [600], [1, "min-h-screen", "flex", "flex-col", "bg-background"], [3, "isOpenChange", "isOpen"], [3, "toggleSidenav"], [1, "flex-1", "w-full", "max-w-5xl", "mx-auto", "px-6", "py-12"], [1, "mb-12", "flex", "flex-col", "md:flex-row", "md:items-end", "md:justify-between", "gap-6"], [1, "font-headline", "font-black", "text-5xl", "md:text-6xl", "text-foreground", "mb-4", "tracking-tighter", "uppercase", "leading-none"], [1, "text-[#635388]"], [1, "text-lg", "text-muted-foreground", "max-w-xl", "font-medium"], [1, "shrink-0", "bg-primary", "border-4", "border-black", "px-6", "py-4", "font-headline", "font-black", "text-lg", "uppercase", "tracking-tighter", "neo-shadow", "hover:bg-accent", "active:translate-x-1", "active:translate-y-1", "active:shadow-none", "transition-all", "flex", "items-center", "gap-2", 3, "click"], [1, "material-symbols-outlined"], [1, "font-headline", "font-bold", "uppercase", "text-muted-foreground"], [1, "border-4", "border-black", "bg-destructive/10", "p-6", "font-bold", "text-destructive"], [1, "mb-12"], [1, "font-headline", "font-black", "text-2xl", "uppercase", "tracking-tighter", "mb-6", "flex", "items-center", "gap-3"], [1, "material-symbols-outlined", "text-2xl"], [1, "bg-white", "border-4", "border-black", "border-dashed", "p-12", "text-center", "flex", "flex-col", "items-center", "gap-4"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-6"], [1, "material-symbols-outlined", "text-6xl"], [1, "font-headline", "font-black", "text-2xl", "uppercase"], [1, "text-muted-foreground", "font-medium", "max-w-md"], [1, "mt-2", "bg-primary", "border-4", "border-black", "px-6", "py-3", "font-headline", "font-black", "uppercase", "tracking-tighter", "neo-shadow", "hover:bg-accent", "active:translate-x-1", "active:translate-y-1", "active:shadow-none", "transition-all", 3, "click"], [1, "bg-card", "border-4", "border-black", "p-6", "neo-shadow", "active-press", "cursor-pointer", "flex", "flex-col", "justify-between", "gap-4", "hover:translate-x-0.5", "hover:translate-y-0.5", "hover:shadow-none", "transition-all"], [1, "bg-card", "border-4", "border-black", "p-6", "neo-shadow", "active-press", "cursor-pointer", "flex", "flex-col", "justify-between", "gap-4", "hover:translate-x-0.5", "hover:translate-y-0.5", "hover:shadow-none", "transition-all", 3, "click"], [1, "font-headline", "font-black", "text-3xl", "text-black", "uppercase", "leading-tight", "mb-3"], [1, "flex", "flex-col", "gap-1", "mb-3"], [1, "text-xs", "font-bold", "uppercase", "text-muted-foreground", "flex", "items-center", "gap-1"], [1, "material-symbols-outlined", "text-sm"], [1, "flex", "flex-wrap", "gap-2"], [1, "flex", "items-center", "gap-1", "bg-white", "border-2", "border-black", "px-3", "py-1", "text-xs", "font-bold", "font-headline", "uppercase"], [1, "bg-white", "border-4", "border-black", "border-dashed", "p-6", "neo-shadow", "cursor-pointer", "flex", "flex-col", "justify-between", "gap-4", "hover:translate-x-0.5", "hover:translate-y-0.5", "hover:shadow-none", "transition-all"], [1, "bg-white", "border-4", "border-black", "border-dashed", "p-6", "neo-shadow", "cursor-pointer", "flex", "flex-col", "justify-between", "gap-4", "hover:translate-x-0.5", "hover:translate-y-0.5", "hover:shadow-none", "transition-all", 3, "click"], [1, "font-headline", "font-bold", "uppercase", "text-muted-foreground", "text-sm"], [1, "flex", "items-center", "gap-3", "mb-6"], [1, "w-6", "h-6", "bg-muted", "animate-pulse", "rounded-sm"], [1, "h-7", "w-40", "bg-muted", "animate-pulse", "rounded-sm"], [1, "bg-card", "border-4", "border-black", "p-6", "neo-shadow", "flex", "flex-col", "justify-between", "gap-4"], [1, "h-8", "w-3/4", "bg-muted", "animate-pulse", "rounded-sm", "mb-3"], [1, "flex", "flex-col", "gap-2", "mb-3"], [1, "h-3", "w-1/2", "bg-muted", "animate-pulse", "rounded-sm"], [1, "h-3", "w-1/3", "bg-muted", "animate-pulse", "rounded-sm"], [1, "flex", "gap-2"], [1, "h-6", "w-24", "bg-muted", "animate-pulse", "rounded-sm", "border-2", "border-black"], [1, "h-6", "w-20", "bg-muted", "animate-pulse", "rounded-sm", "border-2", "border-black"], [1, "h-16", "w-full", "animate-pulse", "bg-muted", "mt-8"]], template: function DashboardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "main", 5)(4, "section", 6)(5, "div")(6, "h1", 7);
      \u0275\u0275text(7, " Suas ");
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(16, DashboardComponent_Conditional_16_Template, 2, 0, "p", 12)(17, DashboardComponent_Conditional_17_Template, 2, 1, "div", 13)(18, DashboardComponent_Conditional_18_Template, 5, 0);
      \u0275\u0275elementEnd();
  ...
  }, dependencies: [HeaderComponent, SidenavComponent], styles: ["\n.active-press[_ngcontent-%COMP%]:active {\n  transform: translate(2px, 2px);\n  box-shadow: 0 0 0 0 black;\n}\n.neo-shadow-yellow[_ngcontent-%COMP%] {\n  box-shadow: 4px 4px 0 0 #ffd700;\n}\n/*# sourceMappingURL=dashboard.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(DashboardComponent, () => [import("./chunk-6DWFAD2T.js").then((m) => m.BrlCurrencyPipe), import("./chunk-X5X5TS5U.js").then((m) => m.RelativeDatePipe), import("./chunk-I7FVYQMU.js").then((m) => m.FooterComponent)], (BrlCurrencyPipe, RelativeDatePipe, FooterComponent) => {
...
\r
      <!-- [ID9] @defer: os cards de eventos s\xE3o conte\xFAdo secund\xE1rio ao carregamento inicial.\r
           O browser renderiza o cabe\xE7alho e o bot\xE3o "Novo Evento" primeiro (LCP mais r\xE1pido),\r
           e s\xF3 monta os cards quando estiver livre (on idle). -->\r
      @defer (on idle) {\r
\r
        <!-- \u2500\u2500 Se\xE7\xE3o: Meus Sorteios \u2500\u2500 -->\r
...
\r
      } @placeholder (minimum 600ms) {\r
\r
        <!-- Pr\xE9via dos cards enquanto o browser est\xE1 ocupado \u2014 mesma estrutura visual dos cards reais -->\r
        <section class="mb-12">\r
          <div class="flex items-center gap-3 mb-6">\r
            <div class="w-6 h-6 bg-muted animate-pulse rounded-sm"></div>\r
            <div class="h-7 w-40 bg-muted animate-pulse rounded-sm"></div>\r
          </div>\r
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">\r
            @for (item of [1, 2]; track item) {\r
              <div class="bg-card border-4 border-black p-6 neo-shadow flex flex-col justify-between gap-4">\r
                <div>\r
                  <div class="h-8 w-3/4 bg-muted animate-pulse rounded-sm mb-3"></div>\r
                  <div class="flex flex-col gap-2 mb-3">\r
                    <div class="h-3 w-1/2 bg-muted animate-pulse rounded-sm"></div>\r
                    <div class="h-3 w-1/3 bg-muted animate-pulse rounded-sm"></div>\r
                  </div>\r
                </div>\r
                <div class="flex gap-2">\r
                  <div class="h-6 w-24 bg-muted animate-pulse rounded-sm border-2 border-black"></div>\r
                  <div class="h-6 w-20 bg-muted animate-pulse rounded-sm border-2 border-black"></div>\r
                </div>\r
              </div>\r
            }\r
          </div>\r
