...
function EventDetailComponent_Conditional_6_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "button", 13)(1, "span", 11);
    \u0275\u0275text(2, "edit_off");
    \u0275\u0275elementEnd();
...
function EventDetailComponent_Conditional_6_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function EventDetailComponent_Conditional_6_Conditional_8_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function EventDetailComponent_Conditional_6_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 19)(1, "span", 24);
...
function EventDetailComponent_Conditional_6_Conditional_22_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_6_Conditional_22_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_6_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "form", 29);
    \u0275\u0275listener("ngSubmit", function EventDetailComponent_Conditional_6_Conditional_22_Template_form_ngSubmit_6_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.addParticipant());
    });
    \u0275\u0275elementStart(7, "div")(8, "label", 30);
    \u0275\u0275text(9, "E-mail");
    \u0275\u0275elementEnd();
    \u0275\u0275element(10, "input", 31);
    \u0275\u0275conditionalCreate(11, EventDetailComponent_Conditional_6_Conditional_22_Conditional_11_Template, 2, 0, "p", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, EventDetailComponent_Conditional_6_Conditional_22_Conditional_12_Template, 2, 1, "p", 33);
    \u0275\u0275elementStart(13, "button", 34)(14, "span", 35);
    \u0275\u0275text(15, "person_add");
    \u0275\u0275elementEnd();
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "div", 36)(18, "div", 37)(19, "span", 38);
    \u0275\u0275text(20, "auto_awesome");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "h2", 28);
    \u0275\u0275text(22, "Link M\xE1gico");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "p", 39);
    \u0275\u0275text(24, " Compartilhe este link para a galera entrar no sorteio. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 40)(26, "div", 41);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "button", 42);
    \u0275\u0275listener("click", function EventDetailComponent_Conditional_6_Conditional_22_Template_button_click_28_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function EventDetailComponent_Conditional_6_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22)(1, "span", 43);
    \u0275\u0275text(2, "celebration");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h2", 44);
...
function EventDetailComponent_Conditional_6_Defer_24_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 49)(1, "p", 53);
    \u0275\u0275text(2, " Ningu\xE9m por aqui ainda. Convide a galera acima! ");
    \u0275\u0275elementEnd()();
  }
}
function EventDetailComponent_Conditional_6_Defer_24_Conditional_7_For_2_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 63);
    \u0275\u0275listener("click", function EventDetailComponent_Conditional_6_Defer_24_Conditional_7_For_2_Conditional_10_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
...
function EventDetailComponent_Conditional_6_Defer_24_Conditional_7_For_2_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 64);
    \u0275\u0275listener("click", function EventDetailComponent_Conditional_6_Defer_24_Conditional_7_For_2_Conditional_11_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const p_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(4);
...
function EventDetailComponent_Conditional_6_Defer_24_Conditional_7_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 54)(1, "div", 55)(2, "div", 56);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 57)(5, "p", 58);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275conditionalCreate(10, EventDetailComponent_Conditional_6_Defer_24_Conditional_7_For_2_Conditional_10_Template, 4, 0, "button", 61)(11, EventDetailComponent_Conditional_6_Defer_24_Conditional_7_For_2_Conditional_11_Template, 3, 0, "button", 62);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function EventDetailComponent_Conditional_6_Defer_24_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 50);
    \u0275\u0275repeaterCreate(1, EventDetailComponent_Conditional_6_Defer_24_Conditional_7_For_2_Template, 12, 4, "div", 54, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function EventDetailComponent_Conditional_6_Defer_24_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 66);
    \u0275\u0275listener("click", function EventDetailComponent_Conditional_6_Defer_24_Conditional_8_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r0 = \u0275\u0275nextContext(3);
...
function EventDetailComponent_Conditional_6_Defer_24_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_6_Defer_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46)(1, "div", 47)(2, "h2", 28);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 48);
    \u0275\u0275text(5, "group");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(6, EventDetailComponent_Conditional_6_Defer_24_Conditional_6_Template, 3, 0, "div", 49)(7, EventDetailComponent_Conditional_6_Defer_24_Conditional_7_Template, 3, 0, "div", 50);
    \u0275\u0275conditionalCreate(8, EventDetailComponent_Conditional_6_Defer_24_Conditional_8_Template, 4, 2, "button", 51)(9, EventDetailComponent_Conditional_6_Defer_24_Conditional_9_Template, 2, 0, "p", 52);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function EventDetailComponent_Conditional_6_DeferLoading_25_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_6_DeferPlaceholder_26_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 72);
    \u0275\u0275element(1, "div", 73);
    \u0275\u0275elementStart(2, "div", 74);
    \u0275\u0275element(3, "div", 75)(4, "div", 76);
    \u0275\u0275elementEnd()();
  }
}
function EventDetailComponent_Conditional_6_DeferPlaceholder_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46)(1, "div", 47);
    \u0275\u0275element(2, "div", 70)(3, "div", 71);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 50);
    \u0275\u0275repeaterCreate(5, EventDetailComponent_Conditional_6_DeferPlaceholder_26_For_6_Template, 5, 0, "div", 72, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(5);
...
function EventDetailComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(7, EventDetailComponent_Conditional_6_Conditional_7_Template, 4, 0, "button", 13)(8, EventDetailComponent_Conditional_6_Conditional_8_Template, 4, 0, "button", 14);
    \u0275\u0275elementStart(9, "button", 15);
    \u0275\u0275listener("click", function EventDetailComponent_Conditional_6_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(11, "delete");
    \u0275\u0275elementEnd();
    \u0275\u0275text(12, " Excluir Sorteio ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "h1", 16);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "p", 17);
    \u0275\u0275text(16, " Convide a galera para o grupo. Quanto mais, melhor. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 18);
    \u0275\u0275conditionalCreate(18, EventDetailComponent_Conditional_6_Conditional_18_Template, 5, 3, "span", 19);
    \u0275\u0275conditionalCreate(19, EventDetailComponent_Conditional_6_Conditional_19_Template, 5, 3, "span", 19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 20)(21, "div", 21);
    \u0275\u0275conditionalCreate(22, EventDetailComponent_Conditional_6_Conditional_22_Template, 31, 8)(23, EventDetailComponent_Conditional_6_Conditional_23_Template, 7, 0, "div", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275domTemplate(24, EventDetailComponent_Conditional_6_Defer_24_Template, 10, 3)(25, EventDetailComponent_Conditional_6_DeferLoading_25_Template, 5, 0)(26, EventDetailComponent_Conditional_6_DeferPlaceholder_26_Template, 7, 1);
    \u0275\u0275defer(27, 24, null, 25, 26, null, 0, null, \u0275\u0275deferEnableTimerScheduling);
    \u0275\u0275deferOnIdle();
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275conditional(ctx_r0.hasDrawn() ? 7 : 8);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", ev_r4.name, " ");
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ev_r4.draw_date ? 18 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ev_r4.budget != null ? 19 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!ctx_r0.hasDrawn() ? 22 : 23);
  }
}
...
function EventDetailComponent_Conditional_8_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 80)(1, "span", 43);
    \u0275\u0275text(2, "visibility");
    \u0275\u0275elementEnd();
...
function EventDetailComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 77)(2, "button", 78);
    ...
    \u0275\u0275text(4, "close");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(5, EventDetailComponent_Conditional_8_Conditional_5_Template, 16, 2, "div", 79)(6, EventDetailComponent_Conditional_8_Conditional_6_Template, 14, 1, "div", 80);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function EventDetailComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 91)(2, "button", 78);
    ...
    \u0275\u0275elementStart(8, "div")(9, "label", 93);
    \u0275\u0275text(10, "Nome do Sorteio");
    \u0275\u0275elementEnd();
    \u0275\u0275element(11, "input", 94);
    \u0275\u0275conditionalCreate(12, EventDetailComponent_Conditional_9_Conditional_12_Template, 2, 0, "p", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div")(14, "label", 95);
    \u0275\u0275text(15, "Or\xE7amento (Opcional)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(16, "input", 96);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div")(18, "label", 97);
    \u0275\u0275text(19, "Data do Sorteio (Opcional)");
    \u0275\u0275elementEnd();
    \u0275\u0275element(20, "input", 98);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "button", 99)(22, "span", 35);
    \u0275\u0275text(23, "save");
    \u0275\u0275elementEnd();
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()()()();
...
var EventDetailComponent = class _EventDetailComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventDetailComponent, selectors: [["app-event-detail"]], inputs: { id: [1, "id"] }, decls: 10, vars: 4, consts: [[300, null], [1, "min-h-screen", "flex", "flex-col", "bg-background"], [3, "isOpenChange", "isOpen"], [3, "toggleSidenav"], [1, "flex-1", "w-full", "max-w-4xl", "mx-auto", "px-6", "py-12"], [1, "font-headline", "font-bold", "uppercase", "text-muted-foreground"], [1, "border-4", "border-black", "bg-destructive/10", "p-6", "font-bold", "text-destructive"], [1, "fixed", "inset-0", "z-50", "flex", "items-center", "justify-center", "bg-black/80", "backdrop-blur-sm", "p-4"], [1, "mb-10"], [1, "flex", "justify-between", "items-center", "mb-4"], ["routerLink", "/dashboard", 1, "inline-flex", "items-center", "gap-1", "font-headline", "font-bold", "uppercase", "text-sm", "text-muted-foreground", "hover:text-foreground"], [1, "material-symbols-outlined", "text-base"], [1, "flex", "items-center", "gap-4"], ["disabled", "", "title", "N\xE3o \xE9 poss\xEDvel editar ap\xF3s o sorteio ser realizado", 1, "inline-flex", "items-center", "gap-1", "text-sm", "font-bold", "uppercase", "text-zinc-400", "cursor-not-allowed"], [1, "inline-flex", "items-center", "gap-1", "text-sm", "font-bold", "uppercase", "text-primary", "hover:opacity-80", "transition-opacity"], [1, "inline-flex", "items-center", "gap-1", "text-sm", "font-bold", "uppercase", "text-destructive", "hover:opacity-80", "transition-opacity", 3, "click"], [1, "text-4xl", "md:text-5xl", "font-black", "font-headline", "uppercase", "tracking-tighter", "mb-2"], [1, "text-lg", "font-medium", "text-muted-foreground"], [1, "flex", "flex-wrap", "gap-3", "mt-4"], [1, "flex", "items-center", "gap-1", "bg-white", "border-2", "border-black", "px-3", "py-1", "text-xs", "font-bold", "font-headline", "uppercase"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-8"], [1, "space-y-8"], [1, "bg-primary/20", "border-4", "border-black", "p-6", "neo-shadow-lg", "text-center", "flex", "flex-col", "items-center"], [1, "inline-flex", "items-center", "gap-1", "text-sm", "font-bold", "uppercase", "text-primary", "hover:opacity-80", "transition-opacity", 3, "click"], [1, "material-symbols-outlined", "text-sm"], [1, "bg-white", "border-4", "border-black", "p-6", "neo-shadow-lg"], [1, "flex", "items-center", "gap-3", "mb-6"], [1, "material-symbols-outlined", "text-3xl", "bg-primary", "p-2", "border-2", "border-black", "neo-shadow"], [1, "text-2xl", "font-black", "font-headline", "uppercase", "italic"], [1, "space-y-4", 3, "ngSubmit", "formGroup"], ["for", "email", 1, "block", "text-xs", "font-black", "uppercase", "mb-1"], ["id", "email", "type", "email", "formControlName", "email", "placeholder", "amigo@exemplo.com", 1, "w-full", "border-4", "border-black", "p-4", "font-bold", "focus:ring-0", "focus:outline-none", "focus:bg-accent", "bg-zinc-50", "transition-colors"], [1, "text-xs", "font-bold", "text-destructive", "uppercase", "mt-1"], [1, "text-sm", "font-bold", "text-destructive"], ["type", "submit", 1, "w-full", "bg-accent", "border-4", "border-black", "font-black", "uppercase", "py-4", "flex", "items-center", "justify-center", "gap-2", "neo-shadow", "hover:translate-x-0.5", "hover:translate-y-0.5", "hover:shadow-none", "active:translate-x-1", "active:translate-y-1", "active:shadow-none", "transition-all", "disabled:opacity-60", "disabled:cursor-not-allowed", 3, "disabled"], [1, "material-symbols-outlined"], [1, "bg-secondary", "border-4", "border-black", "p-6", "neo-shadow-lg"], [1, "flex", "items-center", "gap-3", "mb-4"], [1, "material-symbols-outlined", "text-3xl"], [1, "font-bold", "text-sm", "mb-4"], [1, "flex", "gap-2"], [1, "flex-1", "bg-white", "border-2", "border-black", "p-3", "font-mono", "text-sm", "overflow-hidden", "truncate"], ["type", "button", 1, "bg-black", "text-white", "p-3", "border-2", "border-black", "flex", "items-center", "justify-center", "hover:bg-zinc-800", "active:scale-95", "transition-transform", 3, "click"], [1, "material-symbols-outlined", "text-6xl", "text-primary", "mb-4"], [1, "text-2xl", "font-black", "font-headline", "uppercase", "italic", "mb-2"], [1, "font-bold", "text-sm"], [1, "bg-white", "border-4", "border-black", "p-6", "neo-shadow-lg", "h-fit"], [1, "flex", "justify-between", "items-center", "mb-6"], [1, "material-symbols-outlined", "text-zinc-400"], [1, "bg-zinc-100", "border-2", "border-dashed", "border-black", "p-6", "text-center"], [1, "space-y-4"], [1, "mt-6", "w-full", "bg-primary", "border-4", "border-black", "font-black", "uppercase", "py-4", "flex", "items-center", "justify-center", "gap-2", "neo-shadow", "hover:bg-accent", "transition-all", "disabled:opacity-60", "disabled:cursor-not-allowed", 3, "disabled"], [1, "mt-6", "text-center", "text-xs", "font-bold", "text-zinc-500", "uppercase"], [1, "text-xs", "font-bold", "uppercase", "italic", "text-zinc-500"], [1, "flex", "items-center", "justify-between", "p-3", "border-2", "border-black", "bg-zinc-50", "hover:bg-accent", "transition-colors"], [1, "flex", "items-center", "gap-3", "min-w-0"], [1, "w-10", "h-10", "border-2", "border-black", "bg-primary", "flex", "items-center", "justify-center", "font-black", "uppercase", "shrink-0"], [1, "min-w-0"], [1, "font-black", "text-sm", "truncate"], [1, "text-[10px]", "font-bold", "uppercase", "text-zinc-500"], [1, "flex", "items-center", "gap-2"], ["type", "button", 1, "bg-secondary", "px-3", "py-2", "border-2", "border-black", "text-xs", "font-black", "uppercase", "flex", "items-center", "gap-1", "hover:bg-black", "hover:text-white", "transition-colors"], ["type", "button", "aria-label", "Remover participante", 1, "text-zinc-400", "hover:text-destructive", "transition-colors", "shrink-0"], ["type", "button", 1, "bg-secondary", "px-3", "py-2", "border-2", "border-black", "text-xs", "font-black", "uppercase", "flex", "items-center", "gap-1", "hover:bg-black", "hover:text-white", "transition-colors", 3, "click"], ["type", "button", "aria-label", "Remover participante", 1, "text-zinc-400", "hover:text-destructive", "transition-colors", "shrink-0", 3, "click"], [1, "material-symbols-outlined", "text-xl"], [1, "mt-6", "w-full", "bg-primary", "border-4", "border-black", "font-black", "uppercase", "py-4", "flex", "items-center", "justify-center", "gap-2", "neo-shadow", "hover:bg-accent", "transition-all", "disabled:opacity-60", "disabled:cursor-not-allowed", 3, "click", "disabled"], [1, "bg-white", "border-4", "border-black", "p-6", "neo-shadow-lg", "h-fit", "flex", "items-center", "gap-3"], [1, "material-symbols-outlined", "animate-spin", "text-primary"], [1, "font-headline", "font-bold", "uppercase", "text-muted-foreground", "text-sm"], [1, "h-8", "w-40", "bg-zinc-200", "border-2", "border-black", "animate-pulse"], [1, "w-6", "h-6", "bg-zinc-200", "border-2", "border-black", "animate-pulse"], [1, "flex", "items-center", "gap-3", "p-3", "border-2", "border-black"], [1, "w-10", "h-10", "bg-zinc-200", "border-2", "border-black", "animate-pulse", "shrink-0"], [1, "flex-1", "space-y-2"], [1, "h-3", "bg-zinc-200", "border", "border-black", "animate-pulse", "w-3/4"], [1, "h-2", "bg-zinc-100", "border", "border-black", "animate-pulse", "w-1/3"], [1, "bg-white", "border-4", "border-black", "w-full", "max-w-md", "p-8", "neo-shadow-xl", "text-center", "relative", "animate-in", "fade-in", "zoom-in", "duration-200"], ["type", "button", "aria-label", "Fechar", 1, "absolute", "top-4", "right-4", "text-zinc-400", "hover:text-black", "transition-colors", 3, "click"], [1, "flex", "flex-col", "items-center"], [1, "flex", "flex-col", "items-center", "animate-in", "fade-in", "slide-in-from-bottom-4"], [1, "material-symbols-outlined", "text-6xl", "text-destructive", "mb-4", "animate-bounce"], [1, "text-3xl", "font-black", "font-headline", "uppercase", "italic", "mb-4"], [1, "font-bold", "text-lg", "mb-8"], [1, "bg-primary", "px-2", "border-2", "border-black"], [1, "w-full", "bg-black", "text-white", "font-black", "uppercase", "py-4", "border-2", "border-black", "hover:bg-zinc-800", "transition-colors", 3, "click"], [1, "text-xl", "font-bold", "uppercase", "text-muted-foreground", "mb-2"], [1, "bg-secondary", "border-4", "border-black", "p-6", "w-full", "mb-8"], [1, "text-3xl", "font-black", "font-headline", "uppercase", "italic", "truncate"], [1, "text-sm", "font-bold", "text-zinc-500", "mb-6"], [1, "w-full", "bg-destructive", "text-white", "font-black", "uppercase", "py-4", "border-2", "border-black", "flex", "items-center", "justify-center", "gap-2", "hover:bg-red-600", "transition-colors", 3, "click"], [1, "bg-white", "border-4", "border-black", "w-full", "max-w-md", "p-8", "neo-shadow-xl", "relative", "animate-in", "fade-in", "zoom-in", "duration-200"], [1, "text-2xl", "font-black", "font-headline", "uppercase", "italic", "mb-6"], ["for", "edit-name", 1, "block", "text-xs", "font-black", "uppercase", "mb-1"], ["id", "edit-name", "type", "text", "formControlName", "name", "placeholder", "Ex: Amigo Secreto da Fam\xEDlia", 1, "w-full", "border-4", "border-black", "p-4", "font-bold", "focus:ring-0", "focus:outline-none", "focus:bg-accent", "bg-zinc-50", "transition-colors"], ["for", "edit-budget", 1, "block", "text-xs", "font-black", "uppercase", "mb-1"], ["id", "edit-budget", "type", "number", "formControlName", "budget", "placeholder", "Ex: 50", 1, "w-full", "border-4", "border-black", "p-4", "font-bold", "focus:ring-0", "focus:outline-none", "focus:bg-accent", "bg-zinc-50", "transition-colors"], ["for", "edit-date", 1, "block", "text-xs", "font-black", "uppercase", "mb-1"], ["id", "edit-date", "type", "date", "formControlName", "draw_date", 1, "w-full", "border-4", "border-black", "p-4", "font-bold", "focus:ring-0", "focus:outline-none", "focus:bg-accent", "bg-zinc-50", "transition-colors"], ["type", "submit", 1, "w-full", "bg-primary", "border-4", "border-black", "font-black", "uppercase", "py-4", "flex", "items-center", "justify-center", "gap-2", "neo-shadow", "hover:bg-accent", "transition-all", "disabled:opacity-60", "disabled:cursor-not-allowed", "mt-4", 3, "disabled"]], template: function EventDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(4, EventDetailComponent_Conditional_4_Template, 2, 0, "p", 5)(5, EventDetailComponent_Conditional_5_Template, 2, 1, "div", 6)(6, EventDetailComponent_Conditional_6_Template, 29, 5);
      \u0275\u0275elementEnd();
      \u0275\u0275element(7, "app-footer");
      \u0275\u0275conditionalCreate(8, EventDetailComponent_Conditional_8_Template, 7, 1, "div", 7);
      \u0275\u0275conditionalCreate(9, EventDetailComponent_Conditional_9_Template, 25, 4, "div", 7);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_1_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventDetailComponent, { className: "EventDetailComponent", filePath: "apps/web/src/app/features/events/event-detail/event-detail.component.ts", lineNumber: 27 });
})();
export {
  EventDetailComponent
};
//# sourceMappingURL=chunk-KIGYNW4H.js.map
