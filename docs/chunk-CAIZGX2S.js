...
var _forTrack0 = ($index, $item) => $item.ts;
...
function HeaderComponent_Conditional_8_Conditional_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.notificationCount(), " ");
  }
}
...
function HeaderComponent_Conditional_8_Conditional_5_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "\u{1F381}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div")(5, "p", 22);
    \u0275\u0275text(6, "Sorteio realizado");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function HeaderComponent_Conditional_8_Conditional_5_Conditional_5_For_2_Template_button_click_9_listener() {
      ...
      return \u0275\u0275resetView(ctx_r1.dismissDrawNotification(notif_r5.ts));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", notif_r5.eventName, " ");
  }
}
function HeaderComponent_Conditional_8_Conditional_5_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275repeaterCreate(1, HeaderComponent_Conditional_8_Conditional_5_Conditional_5_For_2_Template, 12, 1, "div", 19, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r1.drawNotifications());
  }
}
function HeaderComponent_Conditional_8_Conditional_5_Conditional_6_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function HeaderComponent_Conditional_8_Conditional_5_Conditional_6_For_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 28)(1, "div")(2, "p", 22);
    \u0275\u0275text(3, "Convite para sorteio");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 23);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 29)(7, "button", 30);
    \u0275\u0275listener("click", function HeaderComponent_Conditional_8_Conditional_5_Conditional_6_For_3_Template_button_click_7_listener() {
      const invite_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.acceptInvite(invite_r7.id));
    });
    \u0275\u0275text(8, " Aceitar ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "button", 31);
    \u0275\u0275listener("click", function HeaderComponent_Conditional_8_Conditional_5_Conditional_6_For_3_Template_button_click_9_listener() {
      const invite_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.declineInvite(invite_r7.id));
    });
    \u0275\u0275text(10, " Recusar ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const invite_r7 = ctx.$implicit;
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", invite_r7.event_name, " ");
  }
}
function HeaderComponent_Conditional_8_Conditional_5_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, HeaderComponent_Conditional_8_Conditional_5_Conditional_6_Conditional_0_Template, 2, 0, "p", 26);
    \u0275\u0275elementStart(1, "div", 27);
    \u0275\u0275repeaterCreate(2, HeaderComponent_Conditional_8_Conditional_5_Conditional_6_For_3_Template, 11, 1, "div", 28, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275conditional(ctx_r1.drawNotifications().length > 0 ? 0 : -1);
    \u0275\u0275advance(2);
...
function HeaderComponent_Conditional_8_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, " Notifica\xE7\xF5es ");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, HeaderComponent_Conditional_8_Conditional_5_Conditional_4_Template, 2, 0, "p", 17);
    \u0275\u0275conditionalCreate(5, HeaderComponent_Conditional_8_Conditional_5_Conditional_5_Template, 3, 0, "div", 18);
    \u0275\u0275conditionalCreate(6, HeaderComponent_Conditional_8_Conditional_5_Conditional_6_Template, 4, 1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r1.notificationCount() === 0 ? 4 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.drawNotifications().length > 0 ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.invitations().length > 0 ? 6 : -1);
  }
}
...
function HeaderComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, HeaderComponent_Conditional_8_Conditional_5_Template, 7, 3);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
...
var HeaderComponent = class _HeaderComponent {
  ...
  drawNotifications = signal([], ...ngDevMode ? [{ debugName: "drawNotifications" }] : (
    /* istanbul ignore next */
    []
  ));
  ...
  notificationCount = computed(() => this.invitations().length + this.drawNotifications().length, ...ngDevMode ? [{ debugName: "notificationCount" }] : (
    /* istanbul ignore next */
    []
  ));
  constructor() {
...
//# sourceMappingURL=chunk-CAIZGX2S.js.map
